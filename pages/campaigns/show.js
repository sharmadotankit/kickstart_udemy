    ...
    renderCards() {
        ...
        const items = [
            ...
            },
            {
                ...
                description: 'A requst tries to withdraw money from the contract. A request must be approved by the approvers'
            },
            {
                header: approversCount,
                meta: 'Number of approvers',
                description: 'Number of people who has contributed to the campaign'
            },
            {
